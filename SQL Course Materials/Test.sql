...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2023 at 03:00 PM
...
-- Database: `sql_hr`
--
CREATE DATABASE IF NOT EXISTS `sql_hr` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sql_hr`;
...
--
CREATE DATABASE IF NOT EXISTS `sql_inventory` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sql_inventory`;
...
--
CREATE DATABASE IF NOT EXISTS `sql_invoicing` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sql_invoicing`;
...
-- Database: `sql_store`
--
CREATE DATABASE IF NOT EXISTS `sql_store` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sql_store`;
